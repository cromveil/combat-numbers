...
public record SpriteSkin(SpriteSheet sheet, @Nullable Integer fillColor, float letterSpacing, boolean colored, float scale) implements Skin {
	...
	public SkinRenderer createVisual(String text) {
		if (sheet == null) {
			CombatNumbers.LOGGER.warn("SpriteSkin with null sheet, falling back to text");
